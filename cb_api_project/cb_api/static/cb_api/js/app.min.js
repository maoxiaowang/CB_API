!function (a) {
  ...
  t.prototype._reset = function () {
    ...
    this._reset(), a(".side-nav").metisMenu(), a(document).on("click", ".button-menu-mobile", function (t) {
      ...
      var lh = window.location.href.split(/[?#]/);
      var t = lh[0], p = lh[1];
      var href = a(this).attr('href');
      // console.log(p)
      if (p == undefined && t.split('/')) {
      ...
      var reg = /prefix=([\w\d-\/]+)(&.*)?$/;
      var ap = reg.exec(href), lp = reg.exec(p);
      if (ap == null || lp == null) {return true}
      ap = ap[1], lp = lp[1];
      lp == ap && (a(this).addClass("active"),
        a(this).parent().addClass("mm-active"),
  ...
  var e = "default", i = "light", o = "dark", n = {sideBarTheme: e, isBoxed: !1, isCondensed: !1, isScrollable: !1, isDarkModeEnabled: !1};
